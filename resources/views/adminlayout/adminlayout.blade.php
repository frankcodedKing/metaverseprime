                                ...
                                <li>
                                    ...
                                    <li class="active has-sub">
                                        ...
                                        <ul class="list-unstyled navbar__sub-list js-sub-list">
                                            ...
                                            <li>
                                                <a href="{{route('pendingdeposits')}}">Pending <span class="text-right" id="">(12)</span></a>

                                        </ul>
                                    </li>
                                </li>
                                <li>
                                    <a href="{{route('runninginvestments')}}">Running Investments</a>
                                </li>
                            ...
                            <div class="header-button">
                                ...
                                <div class="account-wrap">
                                    <div class="account-item clearfix js-item-menu">
                                        ...
                                        <div class="content">
                                            <a class="admin/js-acc-btn" href="#">john doe</a>
                                        </div>
