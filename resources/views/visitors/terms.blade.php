...
<div class="dashbaord-container">
    <div class="container">
       <div class="admin-main">
           <h2 class="main-admin-title">Terms</h2>
            <!--start user section-->
            <div class="admin-user clearfix">
              <div class="user-box">
                 <h4></h4>
                 <a href="#"></a>
              </div>
              <ul class="user-add-info">
                <li>
  ...
  fxcartel-vtn.com is not available to the general public and is opened only to the qualified members of fxcartel-vtn.com, the use of this site is restricted to our members and to individuals personally invited by them. Every deposit is considered to be a private transaction between the fxcartel-vtn.com and its Member.<br><br>
  ...
  As a private transaction, this program is exempt from the US Securities Act of 1933, the US Securities Exchange Act of 1934 and the US Investment Company Act of 1940 and all other rules, regulations and amendments thereof. We are not FDIC insured. We are not a licensed bank or a security firm.<br><br>
    You agree that all information, communications, materials coming from fxcartel-vtn.com
  ...
  All the data giving by a member to fxcartel-vtn.com will be only privately used and not disclosed to any third parties. fxcartel-vtn.com is not responsible or liable for any loss of data.<br><br>
  ...
  fxcartel-vtn.com is not responsible or liable for any damages, losses and costs resulting from any violation of the conditions and terms and/or use of our website by a member. You guarantee to fxcartel-vtn.com that you will not use this site in any illegal way and you agree to respect your local, national and international laws.<br><br>
  ...
  fxcartel-vtn.com reserves the right to accept or decline any member for membership without explanation.<br><br>
  ...
  <p class="auth-copyrights">&copy; 2021 fxcartel-vtn.com. All rights reserved.</p>
