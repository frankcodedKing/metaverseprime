            ...
            @if ($allplans)
                ...
                <form action="{{route('editinvestmentplan', $plan->id)}}" method="post">
                    ...
                    <tr class="tr-shadow">
                        ...
                        <td><input type="text" required name="duration" value="{{$plan->duration}}" id=""></td>
                        <td>
                            <input type="text" required name="repeat"  value="{{$plan->repeat}}" id="">
                        </td>
            ...
            <tr>
                <form action="{{route('createinvestmentplan')}}" method="post">
                    ...
                    <tr class="tr-shadow">
                        ...
                        <td><input type="text" required name="plan" value="" id=""></td>
                        <td>
                            <span class="desc"><input type="number" required value="" name="minimum" id=""></span>
                        </td>
                        <td><input type="number" name="maximum" required id="" value=""></td>
                        <td>
                            <input type="text" name="percentage" required  value="" id="">
                        </td>
                        <td><input type="text" name="duration" required value="" id=""></td>
                        <td>
                            <input type="text" name="repeat" required value="" id="">
                        </td>
                        <td><input type="number" name="noofrepeat" required value="" id=""></td>
                        <td>
